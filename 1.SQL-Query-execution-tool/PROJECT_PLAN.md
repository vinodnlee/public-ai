...
| 2026-02-23 | C.3 follow-up: implement runtime MCP server loading in `src/mcp/client.py` | pending |
| 2026-02-23 | C.4 follow-up: add runtime agent config API for skills/MCP (`/api/agent-config`) | pending |
