...
from src.tools.get_schema_context import get_schema_context
...
def build_supervisor_graph(
    ...
    # Tool for the supervisor to get the schema
    schema_tool = get_schema_context.bind(semantic_layer=semantic_layer)
